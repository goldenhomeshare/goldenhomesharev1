...
export default async function ListingWizardPage() {
  ...
  try {
    ...
    if (!user) {
      return redirect("/api/auth/login?post_login_redirect_url=/sell/wizard");
    }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-lg">
          <h1 className="text-xl font-semibold text-red-600 mb-4">Error Loading Wizard</h1>
          <p className="text-gray-600 mb-4">
            There was an error loading the listing wizard. This could be due to:
          </p>
          ...
          <div className="space-y-2">
            <Link 
              href="/api/auth/login?post_login_redirect_url=/sell/wizard"
