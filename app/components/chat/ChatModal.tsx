...
export function ChatModal({ isOpen, onClose, productId, hostId, hostName, productName, onMessagesRead }: ChatModalProps) {
        ...
        (payload) => {
          ...
          setMessages((prev) => [...prev, {
            ...
            sender: {
              ...
              profileImage: newMessage.senderId === currentUser?.id ? currentUser.profileImage : undefined,
            }
          }]);
        }
      )
  ...
  const handleViewProfile = () => {
    window.open(`/profile/${hostId}`, '_blank');
  };
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg h-[85vh] md:h-[75vh] flex flex-col p-0 mx-2 md:mx-auto">
        <DialogHeader className="px-4 md:px-6 py-3 md:py-4 border-b flex-shrink-0">
          <DialogTitle className="text-base md:text-lg">Chat with {hostName}</DialogTitle>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm px-4">
                    Send a message to {hostName.split(' ')[0]} about {productName}.
                  </p>
                </div>
              ) : (
