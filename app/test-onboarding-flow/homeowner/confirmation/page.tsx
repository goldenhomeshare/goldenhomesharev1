    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 mb-10 text-center">
        ...
        <p className="text-lg text-slate-600 mb-8">
          Thank you for sharing your home on Golden HomeShare. Your listing is now being reviewed by our team.
        </p>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Our team will review your listing within 24-48 hours. Once approved, you will be prompted to complete a background check before your listing is visible to potential housemates. You'll receive an email notification when your listing goes live.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center p-3 border rounded-lg hover:bg-slate-50">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Verify your identity and build trust with potential housemates</p>
              </div>
            </div>
          </div>
        </div>
