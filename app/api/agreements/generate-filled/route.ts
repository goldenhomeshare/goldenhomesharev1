...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("Received form data for filled PDF generation:", JSON.stringify(formData, null, 2));
    ...
    try {
      ...
      const addText = (page: any, text: string, x: number, y: number, fontSize = 10, fontType = font, maxWidth = 500) => {
      ...
      y = addText(page1, 'Golden HomeShare', 250, y, 16, boldFont, 200);
      y = 400; // Center on page

      y = addText(page1, 'Golden HomeShare', 220, y, 14, boldFont, 200);
      y -= 25;
      y = addText(page1, 'Limited License', 230, y, 14, boldFont, 200);
      y -= 25;
      y = addText(page1, 'Agreement', 250, y, 14, boldFont, 200);

      // =========================== PAGE 2 - SECTIONS 1-3 ===========================
      const page2 = pdfDoc.addPage([612, 792]);
      y = 720;

      y = addText(page2, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;

      // Section 1. Parties - EXACT TEXT with field insertions
      y = addText(page2, 'Section 1. Parties', 50, y, 12, boldFont);
      y -= 15;
      ...
      // Section 2. Property - EXACT TEXT with field insertions
      y = addText(page2, 'Section 2. Property', 50, y, 12, boldFont);
      y -= 10;

      y = addText(page2, 'A. Residence.', 50, y, 10, boldFont);
      ...
      y = addText(page2, 'B. Licensee Areas.', 50, y, 10, boldFont);
      ...
      y = addText(page2, 'C. Shared Areas.', 50, y, 10, boldFont);
      ...
      y = addText(page2, 'D. House Rules.', 50, y, 10, boldFont);
      text = `Licensor and Licensee agree to comply with the "House Rules" included in the Property Addendum ("House Rules").`;
      y = addText(page2, text, 70, y, 10, font, 480);
      y -= 10;

      // Section 3. Term - EXACT TEXT with field insertions
      y = addText(page2, 'Section 3. Term', 50, y, 12, boldFont);
      y -= 10;

      y = addText(page2, 'A. Start Date and End Date.', 50, y, 10, boldFont);
      ...
      y = addText(page3, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;

      // Section 3.B - EXACT TEXT
      y = addText(page3, 'B. Termination Rights.', 50, y, 10, boldFont);
      ...
      y = addText(page3, 'C. Moving In.', 50, y, 10, boldFont);
      ...
      y = addText(page3, 'D. Moving Out.', 50, y, 10, boldFont);
      ...
      y = addText(page3, 'E. Holding Over.', 50, y, 10, boldFont);
      ...
      // Section 5. License Fee - EXACT TEXT with field insertion
      y = addText(page3, 'Section 5. License Fee', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page4, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;
      ...
      y = addText(page4, 'Section 6. Repairs and Maintenance', 50, y, 12, boldFont);
      y -= 10;

      y = addText(page4, 'A. Move-In Condition.', 50, y, 10, boldFont);
      ...
      y = addText(page4, 'B. Licensee Obligations.', 50, y, 10, boldFont);
      ...
      y = addText(page4, 'C. Licensor Obligations.', 50, y, 10, boldFont);
      ...
      y = addText(page4, 'Section 7. Use of the Residence', 50, y, 12, boldFont);
      y -= 10;

      y = addText(page4, 'A. Occupants.', 50, y, 10, boldFont);
      ...
      y = addText(page4, 'B. Legal Requirements.', 50, y, 10, boldFont);
      ...
      y = addText(page5, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;
      ...
      y = addText(page5, 'C. Restrictions.', 50, y, 10, boldFont);
      ...
      y = addText(page5, 'D. Guests and Pets.', 50, y, 10, boldFont);
      ...
      y = addText(page5, 'E. Insurance.', 50, y, 10, boldFont);
      ...
      y = addText(page5, 'Section 8. Access by Licensor', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page5, 'Section 9. Liability', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page6, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;
      ...
      y = addText(page6, 'Section 10. Default; Remedies', 50, y, 12, boldFont);
      y -= 10;

      y = addText(page6, 'A. Licensee Defaults.', 50, y, 10, boldFont);
      ...
      y = addText(page6, '1. Termination.', 70, y, 10, boldFont);
      ...
      y = addText(page6, '2. Legal Action.', 70, y, 10, boldFont);
      ...
      y = addText(page6, '3. Removal.', 70, y, 10, boldFont);
      ...
      y = addText(page6, 'B. Licensor Defaults.', 50, y, 10, boldFont);
      ...
      y = addText(page7, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;
      ...
      y = addText(page7, 'Section 11. License Agreement for Shared Occupancy', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page7, 'Section 12. Property Laws', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page7, 'Section 13. Golden HomeShare Platform', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page7, 'Section 14. Governing Law', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page8, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;

      // Section 15. Entire Agreement, Binding Effect, Waivers and Notices - EXACT TEXT
      y = addText(page8, 'Section 15. Entire Agreement, Binding Effect, Waivers and Notices', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page8, 'Section 16. Involvement of Golden HomeShare in Agreement', 50, y, 12, boldFont);
      y -= 10;

      y = addText(page8, 'A.', 50, y, 10, boldFont);
      ...
      y = addText(page8, 'B.', 50, y, 10, boldFont);
      ...
      y = addText(page8, 'Section 17. Waiver of Jury Trial, Set-Off or Counterclaim.', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page8, 'Section 18. Amendments.', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page9, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;

      y = addText(page9, 'Property Addendum', 50, y, 14, boldFont);
      y -= 20;
      ...
      y = addText(page9, 'SHARED AREAS', 50, y, 12, boldFont);
      y -= 15;
      ...
      if (formData.specificItemsOwnership) {
        y -= 10;
        y = addText(page9, 'SPECIFIC ITEMS OWNERSHIP', 50, y, 12, boldFont);
        y -= 10;
      ...
      y = addText(page10, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;

      y = addText(page10, 'Section 3. House Rules', 50, y, 14, boldFont);
      y -= 20;

      // A. Use of Shared Areas
      y = addText(page10, 'A. Use of Shared Areas', 50, y, 12, boldFont);
      y -= 15;
      ...
      y = addText(page10, 'B. Social and Leisure Time', 50, y, 12, boldFont);
      y -= 15;
      ...
      // C. Quiet Hours
      y = addText(page10, 'C. Quiet Hours', 50, y, 12, boldFont);
      y -= 10;
      ...
      // D. Pets
      y = addText(page10, 'D. Pets', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page11, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;

      // E. Guests
      y = addText(page11, 'E. Guests', 50, y, 12, boldFont);
      y -= 10;
      ...
      // F. Communication
      y = addText(page11, 'F. Communication', 50, y, 12, boldFont);
      y -= 10;
      ...
      // G. Chores
      y = addText(page11, 'G. Chores', 50, y, 12, boldFont);
      y -= 10;
      ...
      y = addText(page12, 'Golden HomeShare', 250, y, 14, boldFont, 200);
      y -= 40;
      ...
      // H. Support Services Requested
      if (formData.supportRequested && formData.supportRequested.length > 0) {
        y = addText(page12, 'H. Support Services Requested', 50, y, 12, boldFont);
        y -= 10;
      ...
      // I. Custom Section (renumbered from H if support services are present)
      const customSectionLetter = (formData.supportRequested && formData.supportRequested.length > 0) ? 'I' : 'H';
      y = addText(page12, `${customSectionLetter}. Custom Section`, 50, y, 12, boldFont);
      y -= 10;
      ...
      if (formData.specialConditions) {
        y = addText(page12, 'SPECIAL CONDITIONS', 50, y, 12, boldFont);
        y -= 10;
      ...
      if (formData.additionalNotes) {
        y = addText(page12, 'ADDITIONAL NOTES', 50, y, 12, boldFont);
        y -= 10;
      ...
      return new NextResponse(pdfBytes, {
        headers: {
          ...
          'Content-Disposition': `attachment; filename="golden-homeshare-agreement-${hostNameSafe}-${seekerNameSafe}.pdf"`,
        },
      });
